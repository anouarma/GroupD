...
import org.mql.platform.commons.models.Language;
...
public class Laureate extends User {
	...
	public Laureate(Long id, Set<Role> roles, String firstName, String lastName, String phoneNumber, String email,
			String password, Gender gender, Address address, String yearGraduation, String postOccuped,
			List<Technology> technologies, List<Education> educations, List<Document> attachments,
			List<Language> languages, List<Experiment> experiments) {
